...
from CRUD.models.curso_model import CursoModel
from CRUD.schemas.curso_schema import CursoSchema

from CRUD.core.deps import get_session
...
async  def get_curso(curso_id: int, db: AsyncSession = Depends(get_session)):
    async with db as session:
        ...
        if curso:
            ...
            raise HTTPException(detail=f'Curso não encontrado com o id: {curso_id}', status_code=status.HTTP_404_NOT_FOUND)
